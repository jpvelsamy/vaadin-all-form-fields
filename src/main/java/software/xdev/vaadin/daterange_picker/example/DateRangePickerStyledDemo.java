...
public class DateRangePickerStyledDemo extends Div
{
	...
	protected void initUI()
	{
		...
		//setPadding(false);
		add(new VerticalLayout(this.dateRangePicker), new VerticalLayout(this.taResult, this.btnDarkMode));
		getChildren().forEach(comp -> ((HasSize)comp).setHeight("50%"));
		setHeightFull();
